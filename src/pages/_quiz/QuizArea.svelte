...
<div id="main">
  {#if representation.length > 0 && !resultsScreen}
    ...
    <div class="" id="difficulty">{representation[questionNo].difficulty}</div>
      ...
      {#each representation[questionNo].answerChoices as choice}
        ...
        {:else if representation[questionNo].answered && !representation[questionNo].correct}
          {#if choice === representation[questionNo].answer}
            <div id="choice" class="bg-green-600 text-white border-green-400">
              {choice}
            </div>
          {:else}
            <div id="choice" class="bg-red-600 text-white border-red-400">
              {choice}
            </div>
          {/if}
        {:else}
  ...
  {:else if resultsScreen}
    <div id="results">
      <p id="score">Final Score: <i>{score} / 10</i></p>
